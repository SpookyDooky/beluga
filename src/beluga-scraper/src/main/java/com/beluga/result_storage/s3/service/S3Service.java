...
public class S3Service {
     ...
     *
     * @param resourceIdentifier object key.
     * @param fileContent        contents of the document.
     * @param bucket             location to store it in.
     */
    public void putObject(final String resourceIdentifier,
                          final byte[] fileContent,
                          final String bucket) {
        logger.info("Uploading file to S3.");
        final PutObjectRequest putObjectRequest = PutObjectRequest.builder()
                .bucket(bucket)
                .key(formatKey(resourceIdentifier))
    ...
    private String formatKey(final String resourceIdentifier) {
        return resourceIdentifier.replaceAll("\\\\", "/");
    }
     ...
     */
    public byte[] getObject(final String resourceIdentifier,
                            final String bucket) {
